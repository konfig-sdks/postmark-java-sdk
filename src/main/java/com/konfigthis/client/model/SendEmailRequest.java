...
public class SendEmailRequest {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Bcc recipient email address. Multiple addresses are comma seperated. Max 50.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Recipient email address. Multiple addresses are comma seperated. Max 50.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The sender email address. Must have a registered and confirmed Sender Signature.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "If no TextBody specified HTML email message")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Reply To override email address. Defaults to the Reply To set in the sender signature.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Email tag that allows you to categorize outgoing emails and get detailed statistics.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "If no HtmlBody specified Plain text email message")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(attachments, bcc, cc, from, headers, htmlBody, replyTo, subject, tag, textBody, to, trackLinks, trackOpens, additionalProperties);
  }
