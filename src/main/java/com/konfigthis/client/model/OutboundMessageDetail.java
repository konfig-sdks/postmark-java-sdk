...
public class OutboundMessageDetail {
  ...
  **/
   ...
   * @return the OutboundMessageDetail instance itself
   */
  public OutboundMessageDetail putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attachments, outboundMessageDetail.attachments) &&
        ...
        Objects.equals(this.additionalProperties, outboundMessageDetail.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(attachments, bcc, cc, from, messageID, receivedAt, recipients, status, subject, tag, to, trackLinks, trackOpens, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to OutboundMessageDetail
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OutboundMessageDetail.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<OutboundMessageDetail>() {
           ...
           public OutboundMessageDetail read(JsonReader in) throws IOException {
             ...
             OutboundMessageDetail instance = thisAdapter.fromJsonTree(jsonObj);
