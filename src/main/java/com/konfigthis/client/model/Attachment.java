 ...
 */
@ApiModel(description = "An attachment for an email message.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Attachment {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(content, contentID, contentType, name, additionalProperties);
  }
