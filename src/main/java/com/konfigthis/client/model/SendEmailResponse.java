 ...
 */
@ApiModel(description = "The standard response when a postmark message is sent")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class SendEmailResponse {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(errorCode, message, messageID, submittedAt, to, additionalProperties);
  }
