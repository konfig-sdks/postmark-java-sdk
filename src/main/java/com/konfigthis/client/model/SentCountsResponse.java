...
import com.konfigthis.client.model.SentCountsResponseDaysInner;
 ...
 */
@ApiModel(description = "The result of a get sent counts operation.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class SentCountsResponse {
  public static final String SERIALIZED_NAME_DAYS = "Days";
  @SerializedName(SERIALIZED_NAME_DAYS)
  private List<SentCountsResponseDaysInner> days = null;
  ...
  **/
   ...
   * @return the SentCountsResponse instance itself
   */
  public SentCountsResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.days, sentCountsResponse.days) &&
        ...
        Objects.equals(this.additionalProperties, sentCountsResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(days, sent, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SentCountsResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SentCountsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("Days") != null && !jsonObj.get("Days").isJsonNull()) {
        ...
        if (jsonArraydays != null) {
          ...
          for (int i = 0; i < jsonArraydays.size(); i++) {
            SentCountsResponseDaysInner.validateJsonObject(jsonArraydays.get(i).getAsJsonObject());
          };
        }
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SentCountsResponse>() {
           ...
           public SentCountsResponse read(JsonReader in) throws IOException {
             ...
             SentCountsResponse instance = thisAdapter.fromJsonTree(jsonObj);
