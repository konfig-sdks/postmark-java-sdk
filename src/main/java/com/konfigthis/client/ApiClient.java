...
public class ApiClient extends ApiClientCustom {
    ...
    private String basePath = "http://api.postmarkapp.com";
    ...
    public ApiClient(OkHttpClient client, Configuration configuration) {
        ...
        authentications.put("serverToken", new ApiKeyAuth("header", "X-Postmark-Server-Token"));
        ...
        if (configuration != null) {
            if (configuration.serverToken != null) {
                this.setServerToken(configuration.serverToken);
            }
    ...
    public String getServerToken() {
        return ((ApiKeyAuth) this.getAuthentication("serverToken")).getApiKey();
    }

    public void setServerToken(String apiKey) {
        ((ApiKeyAuth) this.getAuthentication("serverToken")).setApiKey(apiKey);
    }

    public void setServerTokenPrefix(String prefix) {
        ((ApiKeyAuth) this.getAuthentication("serverToken")).setApiKeyPrefix(prefix);
    }
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://api.postmarkapp.com)
